  ...
  const services = [
    {
      ...
      descNp: "जन्म प्रमाणपत्र अभिलेखहरू हेर्नुहोस्, पेश गर्नुहोस्, वा व्यवस्थापन गर्नुहोस्।",
    ...
    },
    {
      ...
      descNp: "मृत्यु प्रमाणपत्र अभिलेखहरू हेर्नुहोस्, पेश गर्नुहोस्, वा व्यवस्थापन गर्नुहोस्।",
    ...
    },
    {
      ...
      descNp: "बसाईंसराई प्रमाणपत्र अभिलेखहरू हेर्नुहोस्, पेश गर्नुहोस्, वा व्यवस्थापन गर्नुहोस्।",
    ...
    },
    {
      ...
      descNp: "सिफारिस पत्र अभिलेखहरू हेर्नुहोस्, पेश गर्नुहोस्, वा व्यवस्थापन गर्नुहोस्।",
    ...
    },
    {
      ...
      descNp: "गुनासो अभिलेखहरू हेर्नुहोस्, पेश गर्नुहोस्, वा व्यवस्थापन गर्नुहोस्।",
    ...
    },
    {
      ...
      descNp: "वडा सूचना अभिलेखहरू हेर्नुहोस्, पेश गर्नुहोस्, वा व्यवस्थापन गर्नुहोस्।",
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans py-10">
      <div className="max-w-5xl mx-auto px-5">
        ...
        {/* Page Header & Local Language Bar */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-8">
          <div className="text-center sm:text-left">
            <h1 className="text-3xl font-extrabold text-slate-900">
              {isNepali ? "वडा प्रमाणपत्र सेवाहरू" : "Ward Certificate Services"}
            </h1>
            <p className="text-sm text-slate-600 mt-1">
              {isNepali
                ? "हेर्न, पेश गर्न, वा अभिलेख व्यवस्थापन गर्न प्रमाणपत्रको प्रकार छान्नुहोस्।"
                : "Choose a certificate type to view, submit, or manage records."}
            </p>
          </div>

          <div className="flex items-center gap-1 bg-slate-200/80 border border-slate-300 rounded-full p-1 shadow-xs shrink-0">
            <button
              type="button"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {services.map((s) => (
              ...
              key={s.key}
              href={s.to}
              className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-blue-200 transition-all"
            >
