...
// Shared Option Configurations matching FatherInfo
...
function MotherInfo({ setFormData, formData, handleChange }) {
  ...
  // Find mother from parents array
  ...
  // Reused state update architecture for the dropdown elements
  const handleMotherSelectChange = (e) => {
    const { name, value } = e.target;
    setFormData((prev) => {
      const updatedParents = [...prev.parents];
      updatedParents[motherIndex] = {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            value={mother.parent_nepali_first_name}
            onKeyDown={(e) =>
        ...
        <div>
          ...
          <input
            ...
            value={mother.parent_nepali_middle_name}
            onKeyDown={(e) =>
        ...
        <div>
          ...
          <input
            ...
            value={mother.parent_nepali_last_name}
        ...
        <div>
          ...
          <select
            ...
            onChange={handleMotherSelectChange}
            required
