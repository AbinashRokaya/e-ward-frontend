...
//
// Presentational pieces and constants now live in analyticsUI.jsx so this
// file and AdminAnalytics.jsx share one visual source.
            ...
            <Panel title="Pending Records — How Long They've Waited">
              <ResponsiveContainer width="100%" height={200}>
                ...
                >
                  ...
                  <YAxis type="category" dataKey="bucket" width={90} tick={AXIS_TICK} axisLine={false} tickLine={false} />
                  <Tooltip />
              ...
              <Panel title="Cause of Death">
                <ResponsiveContainer width="100%" height={220}>
                  ...
                  >
                    <CartesianGrid stroke={CHART.grid} horizontal={false} />
                    <XAxis type="number" allowDecimals={false} tick={AXIS_TICK} axisLine={false} tickLine={false} />
                    <YAxis type="category" dataKey="cause" width={100} tick={AXIS_TICK} axisLine={false} tickLine={false} />
                    <Tooltip />
            ...
            <Panel title="Migration Reasons">
              <ResponsiveContainer width="100%" height={220}>
                ...
                >
                  <CartesianGrid stroke={CHART.grid} horizontal={false} />
                  <XAxis type="number" allowDecimals={false} tick={AXIS_TICK} axisLine={false} tickLine={false} />
                  <YAxis type="category" dataKey="reason" width={120} tick={AXIS_TICK} axisLine={false} tickLine={false} />
                  <Tooltip />
              ...
              <Panel title="By Category">
                <ResponsiveContainer width="100%" height={220}>
                  ...
                  >
                    <CartesianGrid stroke={CHART.grid} horizontal={false} />
                    <XAxis type="number" allowDecimals={false} tick={AXIS_TICK} axisLine={false} tickLine={false} />
                    <YAxis type="category" dataKey="category" width={110} tick={AXIS_TICK} axisLine={false} tickLine={false} />
                    <Tooltip />
              ...
              <Panel title="Priority + SLA">
                ...
                <div className="flex gap-6 mt-4">
                  ...
                  <MiniStat
                    ...
                    color={
                      extra.sla_compliance_pct != null && extra.sla_compliance_pct < 80
                        ? CHART.danger
                        : CHART.success
                    }
                  />
