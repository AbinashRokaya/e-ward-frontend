...
import DeathPreview from "../deathregistration-component/Deathpreview";
import { toast } from "react-toastify";

function EditDeathRegistrationWardChairpersonModal({
  wards,
  death,
  onClose,
  onSaved,
  ...
  const handleVerified = (e) => {
    e.preventDefault();
    fetch(
      `${API_URL}/v1/ward-chairperson/death/${formData.registration_id}/approve`,
      {
        method: "POST",
        credentials: "include",
  ...
  const handleRejected = (e) => {
    ...
    fetch(`${API_URL}/v1/ward-chairperson/${formData.registration_id}/reject`, {
      method: "POST",
      credentials: "include",
      headers: { "Content-Type": "application/json" },
      ...
      .then(() => {
        if (onSaved) onSaved();
        onClose();
        toast.success("Death registration rejected successfully!");
      })
...
export default EditDeathRegistrationWardChairpersonModal;
