...
function EditComplaintWardChairpersonModal({ complaint, onClose, onSaved }) {
  ...
  const canAct = complaint.complaint_status === "VERIFIED";
  ...
  const handleResolve = (e) => {
    ...
    fetch(
      `${API_URL}/v1/ward-chairperson/complaint/${complaint.complaint_id}/approve`,
      {
        method: "POST",
        credentials: "include",
        body,
  ...
  const handleReject = (e) => {
    ...
    setSubmitting(true);
    fetch(
      `${API_URL}/v1/ward-chairperson/complaint/${complaint.complaint_id}/reject`,
      {
        method: "POST",
        credentials: "include",
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h2 className="text-2xl font-bold text-rose-700">
                Complaint Resolution — Ward Chairperson
              </h2>
            </div>
          </div>
          <button
...
export default EditComplaintWardChairpersonModal;
