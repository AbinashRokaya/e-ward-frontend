...
function EditMigrationRegistrationWardSecretaryModal({
  wards,
  migration,
  onClose,
  onSaved,
  ...
  const handleVerified = (e) => {
    e.preventDefault();
    fetch(
      `${API_URL}/v1/ward-secretary/migration/${formData.migration_id}/approve`,
      {
        method: "POST",
        credentials: "include",
  ...
  const handleRejected = (e) => {
    ...
    fetch(`${API_URL}/v1/ward-secretary/${formData.migration_id}/reject`, {
      method: "POST",
      credentials: "include",
      headers: { "Content-Type": "application/json" },
...
export default EditMigrationRegistrationWardSecretaryModal;
