...
function EditDeathRegistrationWardSecretaryModal({
  wards,
  death,
  onClose,
  onSaved,
  ...
  const handleVerified = (e) => {
    e.preventDefault();
    fetch(
      `${API_URL}/v1/ward-secretary/death/${formData.registration_id}/approve`,
      {
        method: "POST",
        credentials: "include",
...
export default EditDeathRegistrationWardSecretaryModal;
