...
function EditDeathRegistrationModal({ death, onClose, onSaved }) {
  ...
  const handlleApproved = (e) => {
    e.preventDefault();
    fetch(
      `${API_URL}/v1/death-registration/${formData.registration_id}/approve`,
      {
        method: "POST",
        credentials: "include",
  ...
  const handlleRejected = (e) => {
    ...
    fetch(
      `${API_URL}/v1/death-registration/${formData.registration_id}/reject`,
      {
        method: "POST",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
...
export default EditDeathRegistrationModal;
