...
function EditComplaintOfficerModal({ complaint, onClose, onSaved }) {
  ...
  const handleApproved = (e) => {
    e.preventDefault();
    setSubmitting(true);
    fetch(`${API_URL}/v1/complaint/${complaint.complaint_id}/approve`, {
      method: "POST",
      credentials: "include",
...
export default EditComplaintOfficerModal;
